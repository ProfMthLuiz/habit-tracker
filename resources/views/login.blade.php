        ...
        <section class="bg-white max-w-[600px] mx-auto p-10 pb-6 mt-4 habit-shadow-lg">
            ...
            <form action="{{ route('auth.login') }}" method="POST" class="flex flex-col">
                ...
                <div class="flex flex-col gap-2 mb-4">
                    ...
                    <input type="email" name="email" placeholder="your@email.com"
                        class="habit-shadow bg-white p-2  @error('email') border-red-500 @enderror">
                    @error('email')
                ...
                <div class="flex flex-col gap-2 mb-4">
                    ...
                    <input type="password" name="password" placeholder="******" class="bg-white p-2 habit-shadow">
                    @error('password')
                        <p class="text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <p class="text-center mt-4">
                Ainda não tem uma conta? <a href="{{ route('site.register') }}"
                    class="underline hover:opacity-50 transition">Registre-se</a>
            </p>
        </section>
    </main>
</x-layout>
